...
try {
  ...
  // 使用相对路径加载，避免 electron-builder 的 pnpm 符号链接问题
  // dev: out/main/ -> ../../vendor/...
  // prod: resources/app/main/ -> ../../vendor/...（通过 extraFiles 放置）
  addonTools = require(path.join(__dirname, '../../vendor/@leagueakari/league-akari-addons')).tools
} catch (e) {}
